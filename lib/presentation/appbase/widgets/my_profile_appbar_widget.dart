...
import 'package:yoursportz/presentation/profile/view_public_profile.dart';
import 'package:yoursportz/providers/appbase/app_base_provider.dart';
import 'package:yoursportz/utils/color.dart';

class MyProfileAppbarWidget extends StatefulWidget {
  const MyProfileAppbarWidget({super.key, required this.phone});
  final String phone;
  @override
  State<MyProfileAppbarWidget> createState() => _MyProfileAppbarWidgetState();
}

class _MyProfileAppbarWidgetState extends State<MyProfileAppbarWidget> {
  @override
        ...
        return Column(
          ...
          children: [
            Row(
              children: [
                Text(
                  appBaseState.userDetails['name'] ?? LocaleKeys.user_name.tr(),
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => EditProfile(
                                  phone: widget.phone,
                                  userDetails: appBaseState.userDetails,
                                  updateUserDetails: (Map<String, dynamic>
                                      updatedUserDetails) {
                                    setState(() {
                                      appBaseState.userDetails =
                                          updatedUserDetails;
                                      appBaseState.age = LocaleKeys.age_years
                                          .tr(args: [
                                        appBaseState
                                            .calculateAge(
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              const ViewPublicProfile(phone: "916006045264")),
                    );
                  },
                  child: Text("See Notif Profile",
                      style: GoogleFonts.inter(
                          color: TColor.borderColor, fontSize: 12)),
                )
              ],
            ),
